...
class MemberAccount extends LetterboxdBaseElement
{
    ...
    protected Collection $devicesRegisteredForPushNotifications;
    ...
    /**
     * @param Collection|array<string> $devices
     */
    protected function setDevicesRegisteredForPushNotifications(Collection|array $devices)
    {
        $this->devicesRegisteredForPushNotifications = collect($devices);
    }
    ...
    /**
     * @param Collection|array<string> $campaigns
     */
